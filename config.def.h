...
ResourcePref resources[] = {
		...
		{ "color256",     STRING,  &colorname[256] },
		{ "color257",     STRING,  &colorname[257] },
		{ "color258",     STRING,  &colorname[258] },
		{ "foreground",   INTEGER, &defaultfg },
		{ "background",   INTEGER, &defaultbg },
		{ "cursor",       INTEGER, &defaultcs },
		{ "reversecursor",INTEGER, &defaultrcs },
		...
		{ "mousescrollrate", INTEGER, &mousescrollrate},
};
